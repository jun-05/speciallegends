    ...
    characterAbility: {
      '101': {
        ...
        '5': {
          name: '땅을 울리는 검',
          effect:
            '공중에서 스킬 사용 시, 충격파가 상대 레전드를 당겨올 수 있게 됩니다. 해당 충격파는 피해를 줍니다.',
        },
      },
      '102': {
        '1': {
        ...
        '2': {
          name: '회복의 일격',
          effect:
            '궁극기의 마무리 공격에 적중된 상대 레전드 한 명당 체력을 일정량 회복합니다.',
        },
        '3': {
          name: '인내',
        ...
        '4': {
          name: '굳건한 의지',
          effect:
            '스킬을 사용할 수 없는 상태일 때 이동속도가 5% 증가하며 기본 공격의 피해량이 증가합니다.',
        },
        '5': {
          name: '강습',
      ...
      '103': {
        ...
        '2': {
          name: '강인한 마음',
          effect:
            '궁극기 사용에 필요한 게이지가 감소하며 기절, 빙결 상태의 지속시간이 감소합니다.',
        },
        '3': {
          name: '묵직한 한방',
          effect: '지상에서 사용하는 스킬이 상대 레전드를 더 멀리 밀어냅니다.',
        ...
        '4': {
          name: '철단익강',
          effect:
            '10회 피격 시, 10초 동안 이동속도가 증가하며, 상대 레전드로부터 받는 피해가 감소합니다.',
        },
        '5': {
          name: '우렁찬 함성',
          effect:
            '궁극기 사용 중 이동속도가 일정량 증가하고 받는 피해가 일정량 감소하며 피격 시마다 스킬의 재사용 대기시간이 1초 감소합니다.',
        },
      },
      '104': {
        '1': {
        ...
        '2': {
          name: '춤추는 칼날',
          effect:
            '상대 레전드를 스매시한 후, 12초 동안 모든 공격의 피해량이 증가합니다.',
        },
        '3': {
          name: '보이지 않는 그림자',
        ...
        '4': {
          name: '약점 발견',
          effect:
            '체력이 50% 이하인 레전드에게 모든 공격의 피해량의 일정 비율을 추가로 피해를 입힙니다.',
        },
        '5': {
          name: '장막 속의 일격',
          effect:
            '궁극기의 은신 상태에서 공격할 때 추가되는 피해량이 증가합니다.',
        },
      },
      '105': {
        '1': {
        ...
        '2': {
          name: '빠른 재장전',
          effect:
            '지상 또는 공중에서 사용하는 기본 공격이 상대 레전드에게 적중할 때마다 스킬의 재사용 대기시간이 감소합니다.',
        },
        '3': {
          name: '인내',
          effect: '궁극기 사용에 필요한 게이지가 감소합니다.',
        ...
        '4': {
          name: '과열된 권총',
          effect:
            '스킬을 사용할 수 없는 상태일 때, 기본 공격의 피해량이 증가합니다.',
        },
        '5': {
          name: '오버클럭',
          effect:
            '궁극기 사용 중 이동속도가 증가하며, 모든 공격의 피해량이 증가합니다.',
        },
      },
      '106': {
        '1': {
        ...
        '2': {
          name: '저리가!',
          effect:
            '자신이 스매시 된 후 주변에 3초간 유지되며 일정량의 피해를 주는 지뢰 3개를 설치합니다.',
        },
        '3': {
          name: '빠르게',
          effect: '이동속도가 증가합니다.',
        ...
        '4': {
          name: '과학적 연계',
          effect:
            '기본 공격으로 상대 레전드를 적중시킬 때마다 스킬의 재사용 대기시간이 감소합니다.',
        },
        '5': {
          name: '지뢰폭격',
          effect:
            '스킬을 공중에서 사용할 때 투척하는 지뢰의 수가 2개로 증가하지만 기존 지뢰보다 폭발 범위가 좁아집니다. 각 지뢰는 폭발하며 피해를 줍니다.',
        },
      },
      '108': {
        '1': {
        ...
        '2': {
          name: '정신집중',
          effect:
            '궁극기 사용에 필요한 자원 중첩 수에 따라 모든 공격의 피해량이 증가합니다.',
        },
        '3': {
          name: '신속한 발걸음',
      ...
      '109': {
        '1': {
          name: '커튼 콜',
          effect:
            '변신이 종료될 때 주변 6방향으로 피해를 주는 원거리 공격을 합니다.',
        },
        '2': {
          name: '변신 회복',
        ...
        '3': {
          name: '영웅의 외침',
          effect:
            ' 변신할 때, 스완 근처의 팀원이 이동속도가 증가하고, 모든 공격의 피해량이 증가합니다.',
        },
        '4': {
          name: '올곧은 성장',
          effect:
            '궁극기 사용에 필요한 자원 1개당 모든 공격의 피해량이 증가하고, ',
        },
        '5': {
          name: '아직 끝나지 않았다',
          effect:
            '변신 중 지상 공격이 상대 레전드에게 적중할 때마다 변신 지속시간이 연장되며 공중 공격이 상대 레전드에게 적중할 때마다 추가로 연장됩니다. ',
        },
      },
      '110': {
        '1': {
        ...
        '2': {
          name: '열화의 불길',
          effect:
            '궁극기 장판에 피해를 받은 상대 레전드의 이동속도가 1초 동안 일정량 감소하고, 점프력이 일정량 감소합니다.',
        },
        '3': {
          name: '불타는 대포',
          effect:
            '궁극기가 사용 가능할 때, 기본 공격과 스킬 공격의 피해량이 증가합니다.',
        },
        '4': {
          name: '아직 한발 남았어요',
          effect:
            '지상에서 사용하는 스킬로 상대 레전드 및 오브젝트를 적중 시키면 재사용 대기시간을 일정량 돌려받으며 피해량이 증가합니다.',
        },
        '5': {
          name: '인화성 탄약',
          effect:
            '궁극기 사용 후, 6초 동안 기본 공격의 탄착 지점에 0.33초당 피해를 입히는 장판을 생성합니다. 각 장판은 3초 동안 유지합니다.',
        },
      },
      '111': {
        '1': {
        ...
        '3': {
          name: '악랄한 저주',
          effect:
            '궁극기에 적중당한 상대 레전드가 변이에 걸려있는 동안 추가 피해를 받습니다.',
        },
        '4': {
          name: '마력 충전',
          effect:
            '기본 공격으로 상대 레전드를 적중시킬 때마다 스킬의 재사용 대기시간이 ',
        },
        '5': {
          name: '거울아 거울아',
          effect:
            '스킬을 사용할 때 발사하는 마법 구체의 수가 5개로 증가하지만 구체의 크기와 폭발 범위가 감소합니다. 각 마법 구체는 140의 피해를 줍니다. ',
        },
      },
      '112': {
        '1': {
        ...
        '4': {
          name: '추격자',
          effect:
            '3초 동안 피격 받지 않으면, 이동속도가 증가하며, 기본 공격의 피해량이 ',
        },
        '5': {
          name: '과도한 열정',
          effect:
            '상대 레전드를 스매시하면, 스킬의 재사용 대기시간이 즉시 초기화 되며 체력을 회복합니다.',
        },
      },
      '113': {
        '1': {
          name: '순간적인 각성',
          effect:
            '스킬 공격으로 상대 레전드를 적중시키면, 3초 동안 기본 공격의 피해량이 ',
        },
        '2': {
          name: '명과 암',
          effect:
            '체력이 50% 이상일 때, 모든 공격의 피해량이 증가하지만 상대 레전드로부터 받는 피해도 증가합니다. 체력이 50% 미만일 때, 상대 레전드로부터 받는 피해량이 감소하지만 모든 공격의 피해량도 감소합니다.',
        },
        '3': {
          name: '흑염의 기운',
        ...
        '4': {
          name: '완전 연소',
          effect:
            '궁극기의 피해량이 증가합니다. 궁극기로 상대 레전드를 스매시하면, 체력을 일정량 회복합니다.',
        },
        '5': {
          name: '봉인해제',
          effect:
            '스킬의 재사용 대기시간이 감소하고, 지상에서 사용하는 스킬의 공격 범위가 증가합니다.',
        },
      },
      '114': {
        '1': {
      ...
      '115': {
        '1': {
          name: '놓치지 않아',
          effect:
            '지상에서 사용하는 스킬의 피해량이 증가하고, 기절 유지시간이 0.5초 증가합니다.',
        },
        '2': {
          name: '끝없는 복수',
          effect:
            '스킬의 피해량이 증가하며, 스킬 공격으로 상대 레전드를 스매시하면 스킬의 재사용 대기시간을 즉시 회복합니다.',
        },
        '3': {
          name: '묻어주겠어',
          effect: '궁극기의 피해량이 증가합니다.',
        ...
        '4': {
          name: '정당한 대가',
          effect:
            '공중에서 사용하는 스킬의 피해량이 증가하고 적중 시, 스킬의 재사용 대기 시간의 일부를 돌려받습니다.',
        },
        '5': {
          name: '차가운 만찬',
          effect:
            '상대 레전드를 스매시하면 일정 시간 동안 기본 공격에 피격된 대상에게 궁극기 피격 효과가 적용됩니다. 해당 효과는 궁극기 보다 더 빨리 폭발하며, 적은 경직을 줍니다.',
        },
      },
      '116': {
        '1': {
          name: '햇살이 내리리',
          effect:
            '공중 기본 공격에 적중당한 상대 레전드의 이동속도가 2초 동안 감소합니다.',
        },
        '2': {
          name: '뜨겁게 타오르리',
        ...
        '3': {
          name: '퍼지는 온기',
          effect:
            '스킬의 장판을 밟은 팀원과 자신의 이동속도가 3초 동안 일정량 증가합니다.',
        },
        '4': {
          name: '일출',
          effect:
        ...
        '5': {
          name: '여명의 힘',
          effect:
            '궁극기 사용에 필요한 게이지가 감소하고, 전방으로 발사되는 빛줄기가 2개 추가됩니다.',
        },
      },
      '117': {
        '1': {
          name: '혈흔 추적',
          effect:
            '체력이 50% 이하인 레전드에게 궁극기가 일정 비율의 추가 피해를 입힙니다.',
        },
        '2': {
          name: '탐스러운 먹잇감',
        ...
        '3': {
          name: '숨바꼭질은 끝났다',
          effect:
            '스킬 공격으로 상대 레전드를 적중시키면, 5초 동안 기본 공격의 피해량이 증가합니다.',
        },
        '4': {
          name: '발톱 벼리기 ',
          effect:
        ...
        '5': {
          name: '만월의 야수 ',
          effect:
            '상대 레전드를 스매시하면 모든 공격의 피해량이 증가합니다. 이 효과는 볼프강이 스매시 당할 때까지 유지됩니다.',
        },
      },
      '118': {
        '1': {
          name: '일거리 추가',
          effect:
            '아이템 획득 시, 15초 동안 이동속도와 모든 공격의 피해량이 증가합니다',
        },
        '2': {
          name: '신속 보고',
          effect:
            '지상에서 사용하는 스킬 공격이 관통합니다. 스킬의 피해량이 증가합니다.',
        },
        '3': {
          name: '적절한 대처',
          effect:
            '궁극기에 피격된 상대 레전드의 이동속도가 3초 동안 감소합니다.',
        },
        '4': {
          name: '목표 추적',
        ...
        '5': {
          name: '업무 마감 임박',
          effect:
            '공격이 상대 레전드에게 적중할 때마다 모든 공격의 피해량이 증가합니다. 레벨에 따라 피해량이 중첩됩니다. 각 중첩은 6초 동안 유지되며, 공격이 적중할 때마다 유지시간이 초기화됩니다.',
        },
      },
      '119': {
        '1': {
        ...
        '2': {
          name: '알레그로',
          effect:
            '기본 이동속도가 6% 증가하며, 기본 공격으로 상대 레전드를 적중시킬 때마다 스킬의 재사용 대기시간이 감소합니다.',
        },
        '3': {
          name: '아다지오',
          effect:
            '공중에서 사용하는 스킬 공격에 팀원의 체력을 일정량 회복하는 능력이 추가됩니다.',
        },
        '4': {
          name: '레지에로',
          effect: '궁극기 사용에 필요한 게이지가 감소합니다.',
        ...
        '5': {
          name: '바다의 축복',
          effect:
            '궁극기 사용 시 물방울이 터진 자리에 힐 장판이 생성됩니다. 장판은 3.8초',
        },
      },
      '120': {
        '1': {
          name: '과충전',
          effect:
            '궁극기가 사용 가능한 상태일 때, 6초 동안 모든 공격의 피해량이 증가합니다.',
        },
        '2': {
          name: '잡아보세요 할 수 있다면',
        ...
        '3': {
          name: '스펙 사기',
          effect:
            '궁극기 게이지를 일정량 가진 상태로 게임을 시작합니다. 부활 시에는 동작하지 않습니다. 궁극기의 회전하는 칼날 범위가 20% 증가합니다.',
        },
        '4': {
          name: '저연비 보장 인증',
          effect: '궁극기 사용에 필요한 게이지가 감소합니다.',
        ...
        '5': {
          name: '하이라이트',
          effect:
            '스킬의 스택이 1개 추가되어 연속으로 스킬을 사용할 수 있도록 변경됩니다. 궁극기의 피해량이 증가합니다.',
        },
      },
      '121': {
        '1': {
        ...
        '3': {
          name: '참고 견디기',
          effect:
            '최대 체력이 증가하고, 기절, 빙결 상태의 지속시간이 20% 감소합니다.',
        },
        '4': {
          name: '이젠 못 참아!',
          effect: '궁극기의 피해량이 증가합니다.',
        ...
        '5': {
          name: '튼튼한 벽돌집',
          effect:
            '스킬 사용으로 생성된 벽 근처에서 브릭이 받는 피해가 감소합니다.',
        },
      },
      '122': {
        '1': {
      ...
      '123': {
        '1': {
          name: '준비된 사냥꾼',
          effect:
            '궁극기가 사용 가능할 때 기본 공격과 스킬 피해량이 증가합니다.',
        },
        '2': {
          name: '돌진하는 양',
          effect:
            '지상에서 사용하는 스킬로 상대를 적중시키면, 8초 동안 모든 공격의 피해량이 증가합니다.',
        },
        '3': {
          name: '사냥의 전율',
          effect:
            '상대를 스매시 하였을 때 궁극기 사용에 필요한 게이지가 감소합니다.',
        },
        '4': {
          name: '몰아치는 공격',
          effect:
            '공중에서 사용하는 스킬로 상대를 적중시키면, 스킬의 쿨다운이 감소합니다.',
        },
        '5': {
          name: '파편 폭탄',
          effect:
            '궁극기의 폭탄이 폭발한 뒤, 작은 폭탄 4개가 추가로 폭발합니다. ',
        },
      },
      '124': {
        '1': {
        ...
        '3': {
          name: '인술 : 화',
          effect:
            '적을 스매시하면 궁극기 쿨다운이 초기화되고, 3초 동안 이동속도가 증가합니다.',
        },
        '4': {
          name: '인술 : 산',
        ...
        '5': {
          name: '인술 : 쿠레나이',
          effect:
            '죽지 않고 상대 레전드를 연속으로 2회 스매시하면 쿠레나이가 강화되어 궁극기 쿨다운 게이지가 감소하고, 이동속도가 4% 증가하고, 일부 공격의 연계가 더 쉬워집니다. 효과는 스매시될 때까지 유지됩니다.',
        },
      },
      '125': {
        '1': {
        ...
        '2': {
          name: '전부 계산대로야!',
          effect:
            '궁극기 사용 후 2초 동안 상대를 스매시 하였을 때, 체력을 회복합니다.',
        },
        '3': {
          name: '정비는 완벽해!',
        ...
        '4': {
          name: '분해해주마!',
          effect:
            '지상에서 사용하는 스킬로 상대 레전드를 적중시키면, 기본 공격의 피해량이 3초 동안 증가합니다.',
        },
        '5': {
          name: '정면돌파',
          effect:
            '궁극기 사용 중 피격될 때, 모든 공격의 피해량이 3초 동안 증가합니다.',
        },
      },
      '126': {
        '1': {
        ...
        '2': {
          name: '혼자서도 잘 해요',
          effect:
            '공중에서 사용하는 스킬로 상대를 적중시키면, 스킬의 쿨다운이 24% 감소합니다.',
        },
        '3': {
          name: '까꿍!',
        ...
        '4': {
          name: '뛰뛰빵빵',
          effect:
            '지상에서 사용하는 스킬의 피해량이12% 증가합니다. 추가로 구르는 동안, 진행 방향을10% 더 전환할 수 있습니다.',
        },
        '5': {
          name: '재밌는건 한 번 더!',
          effect:
            '궁극기로 2명 이상의 상대 레전드를 적중시키면, 궁극기 쿨다운을15% 돌려 받습니다.',
        },
      },
      '127': {
        '1': {
          name: '폼나는 영상',
          effect:
            '궁극기를 사용할 수 있을 때 모든 공격의 피해량이 12% 증가합니다.',
        },
        '2': {
          name: '빈틈없는 오디오를 위해',
        ...
        '3': {
          name: '스트리머 미션',
          effect:
            '스킬로 상대를 타격할 때마다 궁극기의 피해량이 12% 증가하며, 최대 40%까지 증가합니다.',
        },
        '4': {
          name: '극적인 역전 상황 연출',
          effect:
            '체력이 30% 이하일 때 피해량이 18% 증가하고, 상대를 스매시하면 체력이 8% 회복됩니다. 이 재능이 활성화되었을 때 상대를 스매시하면 효과가 스매시 당할 때까지 지속됩니다.',
        },
        '5': {
          name: '제천대성님의 활약을 보라고!',
          effect:
            '게임 시작 후 40초 동안 모든 피해량이 20%증가합니다. 효과가 활성화되어있을 때 상대를 스매시하면, 지속시간이 갱신됩니다.',
        },
      },
      '128': {
        '1': {
          name: '신중한 기다림',
          effect:
            '궁극기의 방어 타이밍이 0.1초 늘어나는 대신, 궁극기 사용에 필요한 게이지가 22%증가합니다.',
        },
        '2': {
          name: '사냥 준비',
          effect:
            '궁극기가 사용 가능할 때, 기본 공격과 스킬 피해량이 17% 증가합니다.',
        },
        '3': {
          name: '야생의 감',
        ...
        '4': {
          name: '재빠른 몸놀림',
          effect:
            '체력이 10%씩 낮아질 때마다, 궁극기 피해량이 6%증가합니다. 최대 54%까지만 증가합니다.',
        },
        '5': {
          name: '맹수 본능',
          effect:
            '스킬의 스택이 1개 추가되어 연속으로 스킬을 사용할 수 있도록 변경됩니다. 스킬의 쿨다운이 11% 감소합니다.',
        },
      },
      '129': {
        '1': {
      ...
      '130': {
        '1': {
          name: '의기양양',
          effect:
            '기본 공격으로 상대를 적중시킬 때마다 스킬의 쿨다운이 0.13초씩 감소합니다.',
        },
        '2': {
          name: '밤사냥',
          effect:
            '궁극기가 사용 가능한 상태일 때, 1초 동안 이동속도가 30% 증가합니다.',
        },
        '3': {
          name: '정기흡수',
          effect:
            '궁극기 게이지를 34% 지니고 부활합니다. 부활한 후, 3초 동안 이동속도가 15% 증가합니다.',
        },
        '4': {
          name: '비장의 패',
          effect:
            '스킬 공격의 피해량이 30% 증가합니다. 이제 스킬 공격을 통해 스택을 쌓을 수 없습니다.',
        },
        '5': {
          name: '나비효과',
          effect:
            '궁극기로 스택 개수가 1개 이상인 상대 적중 시, 궁극기의 재사용 대기시간이 초기화 됩니다. 추가로 스택 당 140만큼 체력을 회복합니다. 궁극기 사용에 필요한 게이지가 2배로 늘어납니다.',
        },
      },
      '131': {
        '1': {
          name: '전하 충전',
          effect:
            '기본 공격으로 상대를 적중시킬 때마다 스킬의 쿨다운이 0.2씩 감소합니다.',
        },
        '2': {
          name: '전광석화',
        ...
        '3': {
          name: '순서의 도식화',
          effect:
            '스킬의 프랑 캔을 투척하여 상대를 적중시키면, 2초 동안 모든 피해량이 26% 증가합니다.',
        },
        '4': {
          name: '전압 향상',
          effect:
            '스킬의 스택이 1개 추가되며, 날아가는 프랑 캔의 피해량이 18% 증가합니다.',
        },
        '5': {
          name: '한계를 넘어서',
          effect:
            '프랑 캔 트랜스미션이 폭발할 때, 폭발 범위에 있는 빅터를 포함한 팀원은 5초 동안 모든 피해량이 28% 증가하며, 이동 속도가 12% 증가합니다.',
        },
      },
      '132': {
        '1': {
          name: '독무대',
          effect:
            '궁극기 사용에 필요한 게이지가 50% 증가하는 대신, 로렌의 모든 공격의 피해량이 40% 증가합니다.',
        },
        '2': {
          name: '공중왈츠',
          effect:
            '공중 기본 공격으로 상대를 적중시킬 때마다 공중 기본 공격의 피해량이 22%씩 증가합니다. 2초 동안 유지되며, 공격에 성공할 경우 남은 시간이 초기화 됩니다.',
        },
        '3': {
          name: '스텝 업',
          effect:
            '기본 공격으로 상대를 적중시킬 때마다 스킬의 쿨다운이 0.4초씩 감소합니다.',
        },
        '4': {
          name: '보디가드',
          effect:
            '궁극기 게이지를 34% 가진 상태로 게임을 시작합니다. 부활 시에는 동작하지 않습니다. 이제 벡스가 폭발과 함께 나타나며, 폭발은 600의 피해 주며, 2초동안 이동속도를 20% 감소시킵니다.',
        },
        '5': {
          name: '일심동체',
          effect:
            '상대 레전드를 스매시하면, 궁극기 쿨다운 게이지를 40% 획득합니다. 로렌의 체력을 11% 회복합니다.',
        },
      },
      '133': {
        '1': {
        ...
        '2': {
          name: '한파주입',
          effect:
            '공격을 적중시킬 때마다 상대 레전드의 이동속도가 4% 씩 감소합니다. 5초 동안 유지되며, 최대 12% 감소합니다.',
        },
        '3': {
          name: '폭풍전야',
        ...
        '5': {
          name: '여왕의 귀환',
          effect:
            '체력이 20% 이하일 때, 얼음이 되어 2초 동안 상대 레전드의 모든 공격을 무시하고, 체력을 18% 회복합니다. 부활할 때마다 초기화됩니다.',
        },
      },
      '134': {
        '1': {
          name: '마무리도 깔끔히',
          effect:
            '궁극기 사용 후, 5초 동안 다음 사용하는 스킬의 피해량이 34% 증가합니다.',
        },
        '2': {
          name: '스릴이 좋아',
          effect:
            '스킬을 사용할 수 없는 상태일 때, 이동 속도가 5% 증가하며, 기본 공격의 피해량이 36% 증가합니다.',
        },
        '3': {
          name: '눈보다 빠른 손',
          effect:
            '궁극기 사용에 필요한 게이지가 20% 감소합니다. 상대 레전드를 궁극기로 스매시하면, 추가로 단검을 4개 더 뿌립니다. 추가된 단검은 1개 당 100의 피해를 입힙니다.',
        },
        '4': {
          name: '어디에도 없고 어디에든 있다',
          effect:
            '궁극기 사용 중에는 은신 상태가 됩니다. 은신 상태에서 이동속도가 28% 증가합니다.',
        },
        '5': {
          name: '목표물은 놓치지 않아!',
          effect:
            '스킬이 상대 레전드에 적중하면, 상대 레전드의 이동속도가 2초 동안 40% 감소하고, 5초 동안 자신의 모든 공격의 피해량이 18% 증가합니다.',
        },
      },
      '135': {
        '1': {
        ...
        '2': {
          name: '군자는 늘 준비되었으니',
          effect:
            '스킬을 사용할 수 없는 상태일 때, 기본 공격의 피해량이 30% 증가합니다.',
        },
        '3': {
          name: '힘은 넘쳐나며',
        ...
        '5': {
          name: '모두 두려워하라',
          effect:
            '궁극기의 피해량이 16% 증가하고, 궁극기에 피격된 상대는 받는 피해가 8초 동안 16% 증가합니다.',
        },
      },
      '136': {
        '1': {
          name: '입고 예정입니다',
          effect:
            '궁극기를 사용할 수 없는 상태일 때, 기본 공격의 피해량이 24 증가합니다.',
        },
        '2': {
          name: '하나 더 드려요',
          effect:
            '지상 스킬로 상대를 적중시키면, 재사용 대기시간이 1.1초 감소합니다.',
        },
        '3': {
          name: '단골 서비스입니다',
          effect:
            '지상 스킬로 상대를 적중시키면, 7초 동안 지상 스킬의 피해량이 30 증가합니다.',
        },
        '4': {
          name: '손해 보고 팔아요',
          effect:
            '세 번째 지상 공격 혹은 지상 스킬이 사용되는 동안, 받는 피해가 30 감소합니다.',
        },
        '5': {
          name: '폭탄 세일입니다',
          effect:
            '궁극기 투사체가 땅에 닿으면, 절반의 피해를 주는 작은 투사체를 추가로 생성합니다. 궁극기 피해량이 16 증가합니다.',
        },
      },
      '137': {
        '1': {
          name: '환호성',
          effect:
            '궁극기의 착지 공격에 적중된 상대 레전드 한 명당 체력을 4% 회복합니다.',
        },
        '2': {
          name: '연속동작',
          effect:
            '스킬이 상대 레전드에 적중하면, 재사용 대기시간이 0.6초 감소합니다.',
        },
        '3': {
          name: '인어의 노래',
          effect:
            '이동 속도가 3% 증가합니다. 지상 스킬 사용 시 이동 경로에 1초 동안 유지되는 물의 흐름을 만듭니다. 물의 흐름을 따라가는 팀원은 이동속도가 12% 증가합니다.',
        },
        '4': {
          name: '준비동작',
          effect:
            '지상 공격의 마지막 공격으로 상대를 적중시킬 경우, 궁극기 쿨다운 게이지를 3% 획득합니다.',
        },
        '5': {
          name: '앙코르!',
          effect:
            '궁극기 사용 시 한 번 더 도약합니다. 세 번째 도약 공격은 1레벨 기준 700의 피해를 줍니다. 궁극기의 피해량이 8% 증가합니다.',
        },
      },
      '138': {
        '1': {
          name: '선행연구',
          effect:
            '지상 공격의 마지막 공격으로 상대 레전드를 적중시킬 경우, 정수가 생성되어 궁극기 쿨다운 게이지를 20% 획득할 수 있습니다. 지상 공격의 피해량이 8% 증가합니다.',
        },
        '2': {
          name: '양성 피드백',
          effect:
            '공중 스킬로 상대 레전드를 적중시킬 경우, 생성된 정수를 얻어 체력을 1레벨 기준 100 회복합니다.',
        },
        '3': {
          name: '환경 적응',
          effect:
            '5초 동안 피격당하지 않았다면 레터스의 공격력이 12% 증가합니다. 상대 레전드에게 피격 당했을 경우, 5초 동안 이동속도가 4% 증가합니다.',
        },
        '4': {
          name: '변수 차단',
        ...
        '5': {
          name: '마그눔 오푸스',
          effect:
            '스킬의 스택이 1개 추가되며, 지상 스킬의 피해량이 28% 증가합니다.',
        },
      },
    },
  },
    ...
    characterAbility: {
      '101': {
        '1': {
          ...
          effect:
            'When no attack has been performed for 5 sec, increases damage the next attack’s.',
        },
        '2': {
          name: 'Heavy Sword',
        ...
        '5': {
          ...
          effect:
            'The shockwave pulls opponents in when used as Aerial Skill. The shockwave deals damage.',
        },
      },
      '102': {
        '1': {
      ...
      '111': {
        ...
        '5': {
          name: 'Mirror Mirror',
          effect:
            'The number of magical orbs fired when using Skill is increased to 5, but the size and explosion area decreases. Each magical orb deals 140 damage',
        },
      },
      '112': {
        '1': {
        ...
        '2': {
          name: 'Blitz Blade',
          effect:
            'Increases next Skill damage after using your Ultimate ability.',
        },
        '3': {
          name: 'Secret Blow',
        ...
        '4': {
          name: 'Pursuit',
          effect:
            'Increases Movement Speed and Basic Attack damage until receiving damage, if no damage was received for 3 s.',
        },
        '5': {
          name: 'Zeal',
          effect:
            'Reset your Skill cooldown and recover your max HP by smashing your opponent.',
        },
      },
      '113': {
        '1': {
      ...
      '116': {
        ...
        '5': {
          ...
          effect:
            'Decreases gauge charge required for Ultimate and fires 2 additional ray ',
        },
      },
      '117': {
        '1': {
      ...
      '124': {
        ...
        '3': {
          name: 'Ninjutsu: Fire',
          effect:
            'Resets Ultimate cooldown and increases Movement Speed for 3 sec',
        },
        '4': {
